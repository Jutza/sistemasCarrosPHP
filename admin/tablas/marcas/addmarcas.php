...
if(isset($_POST['btnsave']))
{
  ...
  // escribir lo que esta escrito en la propiedad name del input
    ...
    {
      $errMSG = "Favor de introducir la marca.";
    }
...
<strong>Success!</strong><a href="marca.php">Mostrar Registros</a></div>
...
<input type="text" id="marca" name="marca" class="form-control" placeholder="Agrega la marca" onpaste="return false">
       </div>
    </div>
