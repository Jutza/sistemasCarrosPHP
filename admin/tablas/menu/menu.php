...
<body>
    ...
    <div id="wrapper">
        ...
        <div id="sidebar-wrapper">
            <ul class="sidebar-nav">
                ...
                <li>
                    <a href="../tablas/detalles/detalles.php">Producto mas vendido</a>
                </li>
                <li>
                    <a href="../tablas/usuarios/usuarios.php">Producto menos vendido</a>
                </li>
                </li>
                <li>
                    <a href="../tablas/menu/climasc.php">Cliente que mas ha comprado</a>
                </li>
                </li>
  ...
  echo "<td>" . '<img src="../fotos/'.$_SESSION['foto'] .'" width="120" height="140">'."</td>";
        ...
        <p><a class="btn btn-lg btn-success" href="#" role="button"><?php echo $_SESSION['alias'] ?></a></p>
      </div>
